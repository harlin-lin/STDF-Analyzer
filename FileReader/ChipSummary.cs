...
namespace FileReader {
    ...
    public class ChipSummary : IChipSummary {
        ...
        public Dictionary<UInt16, int> GetSoftBins() {
            return new Dictionary<ushort, int>(_softBins);
        }
        ...
        public void Add(IChipSummary summary) {
        ...
        public static ChipSummary Combine(Dictionary<byte, IChipSummary> summaryBySite) {
